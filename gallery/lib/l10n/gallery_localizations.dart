...
class _GalleryLocalizationsDelegate extends LocalizationsDelegate<GalleryLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ml', 'hi', 'es', 'it', 'ja', 'fr', 'uk', 'am', 'fil', 'gu', 'pt', 'lv', 'ar', 'zh', 'bg', 'tr', 'de', 'mr', 'mn', 'te', 'cs', 'sl', 'pa', 'ka', 'da', 'en', 'gl', 'lo', 'gsw', 'as', 'my', 'sv', 'ro', 'ko', 'et', 'bs', 'ca', 'lt', 'is', 'hr', 'vi', 'eu', 'sk', 'he', 'ta', 'ru', 'nl', 'hu', 'bn', 'th', 'ur', 'tl', 'or', 'fi', 'af', 'km', 'be', 'az', 'zu', 'nb', 'ky', 'el', 'pl', 'sr', 'kn', 'mk', 'si', 'id', 'kk', 'fa', 'hy', 'ms', 'ne', 'sq', 'uz', 'sw'].contains(locale.languageCode);
